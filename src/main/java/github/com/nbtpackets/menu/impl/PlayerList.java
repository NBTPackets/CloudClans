package github.com.nbtpackets.menu.impl;
...
import github.com.nbtpackets.menu.MenuHolder;
import github.com.nbtpackets.menu.MenuManager;
import github.com.nbtpackets.menu.MenuType;
import github.com.nbtpackets.menu.config.MenuConfig;
import github.com.nbtpackets.menu.helper.MenuHelper;
import github.com.nbtpackets.menu.helper.PaginatedMenu;
import github.com.nbtpackets.model.Clan;
import github.com.nbtpackets.item.ItemBuilder;
...
public class PlayerList extends PaginatedMenu {
    ...
    protected void loadPageItems(Inventory inventory, ConfigurationSection menuSection, List<Integer> playerSlots, int currentPage) {
        ...
        FileConfiguration config = CloudClans.getInstance().getConfig();
    ...
    protected void handlePlayerSlotClick(Player player, int slot) {
        ...
        Optional.ofNullable(slotToPlayer.get(slot))
                ...
                .ifPresent(targetUuid ->
                        CloudClans.getInstance().getClanManager()
                                .getClan(clan.name())
                                .ifPresent(freshClan ->
