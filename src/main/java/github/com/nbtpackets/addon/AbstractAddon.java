package github.com.nbtpackets.addon;
...
public abstract class AbstractAddon {
    ...
    final void init(AddonDescription description, AddonClassLoader classLoader, AddonLoader addonLoader) {
        ...
        this.logger = Logger.getLogger("CloudClans#" + description.name());
        this.dataFolder = new File(new File(CloudClans.getInstance().getDataFolder(), "addons"), description.name());
    ...
    public EconomyManager getEconomy() {
        return CloudClans.getInstance().getEconomyManager();
    }

    /**
     * Возвращает логгер аддона с именем вида {@code CloudClans#AddonName}
     *
     * @return {@link Logger}
     */
    ...
    /**
     * Возвращает папку данных аддона: {@code plugins/CloudClans/addons/<AddonName>/}.
